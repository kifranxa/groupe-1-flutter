...
class Cycle{
  ...
  Cycle({required this.start, required this.end, required this.duration, required this.periodStart, required this.periodEnd, required this.fertilityStart, required this.fertilityEnd})
